...
{\sl Databases:} MongoDB, Redis, DynamoDB, MySQL, ElasticSearch; \\
{\sl Testing tools:} Mocha, Chai, Sinon.js, Jest, Karma; \\
{\sl Frontend development platforms (had experience with):} React, Angular, jQuery;\\
{\sl Experience with AWS Services:} Lambda, ECS, CloudFormation, ElastiCache, Kinesis, SNS, SQS, S3, SES among others; \\
{\sl Delivery and build tools:} Docker, Webpack, Jenkins, Serverless (for AWS deployments)
